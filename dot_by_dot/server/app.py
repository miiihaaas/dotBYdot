    ...
    walking_1 = {
        "en": {
            ...
            "restStops": [
                ...
                {
                    "name": "Bistro",
                    "description": "Bistro, a resting station",
                    "latlng": [42.86656, 21.91188]
                },
            ],
        },
        "sr": {
            ...
            "restStops": [
                ...
                {
                    "name": "Bistro",
                    "description": "Bistro, stanica za odmor",
                    "latlng": [42.86656, 21.91188]
                },
            ],
        },
    ...
    cycling_1 = {
        "en": {
            ...
            "locations": [
                ...
                {
                    "name": 'Museum of Textile Industry Strojkovce',
                    "description": 'The Textile Museum in Strojkovce is the only museum of its kind in Serbia. It is housed in a watermill built in the second half of the 19th century. Judging by its size and the living quarters within it, it was owned by wealthy Turks. In 1884, enterprising residents of Leskovac opened the first factory for making braids, considered the beginning of the textile industry in Serbia.\nThe building represents the type of "Crnotravska dundjerska house". The watermill is located in the left wing, while the living quarters are in the right wing on the ground floor and first floor. Above the entrance section on the ground floor is a terrace with arcades.\nThe watermill was purchased from former owners and restored in 1959. The building has retained the specific beauty of the architecture characteristic of the time it was built, and the interior is furnished with authentic furniture and items from the daily life of the miller. It houses original items that present the process of making braids.\nThe museum was reconstructed in 2011, restoring the building to its former glory, and the former authentic method of making braids is back in operation. The channel through which water flowed, powering the mechanism for turning spindles and braiding, has also been restored.\nThe Textile Museum in Strojkovce was declared a cultural monument in 1980.',
                    "short_description": 'The Textile Museum in Strojkovce is the only museum of its kind in Serbia.',
                    "latlng": [42.905583, 21.923250],
                    "distance_radius": 50.5,
                    "pictures": [f'{server_route}/static/pictures/29.jpg'],
                },
                {
                    "name": 'Production "Fungo Jug"',
                    "description": 'The company Fungo Jug was founded in 1990. The main activity of the company is the purchase, processing, production, and sale of agricultural and forest products. The geographical location and climatic conditions of the Jablanica District provide a favorable environment for the development of various types of fruits and forest products.\nFungo Jug d.o.o. is a company engaged in the purchase, production, processing, and sale of agricultural and forest products. It was founded in 1990 as a mixed company with Serbian-Italian capital and initially had 5 permanent employees. Now it has over 50 permanent employees and about 50-100 seasonal workers. In the first 10 years, the company’s activities were mainly based on the purchase, processing, and sale of wild mushrooms: porcini, chanterelles, black trumpets. The company owns and leases long-term fruit plantations covering about 15 hectares in the village of Lapotince, near Bojnik. There are plantations of blackberries and sour cherries. Most of the plots under the plantations have artesian wells with a drip irrigation system for timely watering. Also, a few years ago, parcels with pears, apples, and cherries were leased from the city of Leskovac for 10 years, covering about 60 hectares.\nThe company is one of the major exporters of agricultural and forest products. It is engaged in the processing and sale of frozen fruits and forest products for industrial use. With some buyers, there has been a business cooperation of 25 years or more, with business activities agreed upon before the upcoming season. Through Horeca distributors, the company supplies hotels and restaurants in Serbia with frozen products.',
                    "short_description": 'The company Fungo Jug was founded in 1990. The main activity of the company is the purchase, processing, production, and sale of agricultural and forest products.',
                    "latlng": [42.874814, 21.953399],
                    "distance_radius": 50.5,
                    "pictures": [f'{server_route}/static/pictures/30.jpg'],
                },
                {
                    "name": 'Monastery Čukljenik',
                    "description": "The Church of St. Nicholas in Čukljenik, it is not known when the church was built, but it is known that there was a medieval church on this site. It is mentioned in Turkish records as a monastery in 1516, 1530, and 1536. In 1575, the church was destroyed but was soon rebuilt. The church most likely suffered again in 1841, during the Niš Rebellion. Felix Kanitz visited this monastery and found the ruined church. He also records that 'next to the foundations of the destroyed church of St. Nicholas, there is a barely preserved low building with a semicircular vault and conventional Byzantine frescoes; next to it are still, much higher, a solid one-story residence and an auxiliary building where pious pilgrims and visitors find accommodation, but in those days when the Nakrivanski priest serves the Liturgy here, it is not allowed.' During the First Serbian Migration in 1690, the monastery was visited by the Patriarch of Peć Arsenije Čarnojević, who stayed there for a month. In 1786, during the time of Metropolitan of Niš Kalinik I and monks Joanikije and Ignatije, the Church of the Assumption of the Blessed Virgin Mary was built. Prota Dragutin Đorđević recorded two versions of the fate of this church. According to the first, the church was consecrated by Metropolitan Kalinik, who forbade services to be held in the Church of St. Nicholas. Prota Đorđević sees in this act of the metropolitan a desire to impose the Greek language and services. This caused great revolt among the people, who destroyed this church. According to the second, master Ignjat, who built this Church, predicted a quick collapse, because the church was made of river stone pebbles. According to this legend, a certain priest Mihailo lived next to the Church. On Theodore's Saturday, a man with a white beard appeared to him in a dream and told him: 'Mihailo, go with the sacristan to the large, Greek Church, remove the doors, icons and other things, the Church will collapse.' After they did what was instructed, the church collapsed. This Church was restored at the beginning of the 20th century by the parish priest of Strojkovac Sava Avramović. From the old church, the Holy Altar was preserved, and the icons from the church were placed on the iconostasis of the Church of St. Nicholas. Many things in these stories of Prota Dragutin Đorđević do not match, so both legends can be dismissed. For example, the inscriptions on the frescoes in today's Church of St. Nicholas are signed in Greek, and the icons on the iconostasis in Slavic. It is more likely that the Church of the Assumption of the Blessed Virgin Mary, which collapsed, was built by the Serbs, and that the preserved church of St. Nicholas was built by Greek monks. The Church of the Assumption of the Blessed Virgin Mary houses a copperplate engraving on silk, the Ascension of Christ with a depiction of the Patriarchate of Peć, the work of Hristifor Ževarović, who visited this monastery in 1743 and donated the copperplate engraving. After the liberation of the Southern regions, the monastery was converted into a parish church in 1884. In the churchyard, there is a monument to the soldiers and civilians who died in the Serbian-Turkish War. Not far from the churchyard, there is a very well-preserved church mill, which is still in function. It was most likely built in 1786, as evidenced by a record by the monk Ignatije. The mill was recently restored.",
                    "short_description": 'The Church of St. Nicholas in Čukljenik, it is not known when the church was built, but it is known that there was a medieval church on this site.',
                    "latlng": [42.867167, 21.960972],
                    "distance_radius": 31,
                    "pictures": [f'{server_route}/static/pictures/31.jpg'],
                },
                {
                    "name": 'Nakrivan',
                    "description": "There is a legend that a local resident of this village, who was crippled in the leg, often went to his feudal lord in Leskovac and begged him to be exempt from taxes because he was poor and crippled. Over time, the feudal lord got tired of this peasant's insistence and mockingly called him Nakrivan, and later the whole village got its name from him. As for the Nakrivanski Chifluk, it got its name from the role it had in the past. Namely, it was a chifluk, i.e., a large natural estate that was part of Nakrivan, and on the territory of the chifluk, the residents of Nakrivan had their cottages and arable lands, where they occasionally went to perform various tasks. The village is located halfway between Strojkovac and Čukljenik, on the banks of the Nakrivanska River and along the road that led through here for 400 years during the Turkish era, connecting Leskovac and Vranje via the Kukavica mountain, i.e., Belgrade with Thessaloniki. Almost settled under the very peak of Kita, the final height of Kukavica, in the central part of the valley, on an undulating terrace shaped by the Nakrivanska River, Nakrivan is a sub-mountain village and in its area there are plains, hills, and mountains. Such a topographical position of the village favored its development, so Nakrivan has always been the second largest village in the entire Porečje region, which also had its chifluk — today's Nakrivanski Chifluk and its hamlet — the eastern part of Rašin Laz.",
                    "short_description": "There is a legend that a local resident of this village, who was crippled in the leg, often went to his feudal lord in Leskovac and begged him to be exempt from taxes because he was poor and crippled. Over time, the feudal lord got tired of this peasant's insistence and mockingly called him Nakrivan, and later the whole village got its name from him.",
                    "latlng": [42.884230, 21.942366],
                    "distance_radius": 32,
                    "pictures": [f'{server_route}/static/pictures/32.jpg'],
                },
                {
                    "name": 'Monument to the Fallen Fighter',
                    "description": 'The monument to Slavko Todorović was unveiled on July 4, 1973, dedicated to the first victim of the "Kukavica Partisan Detachment". It was unveiled by Svetozar Krstić. The monument was created by academic sculptor Đorđe Vasić from Leskovac. On the monument are inscribed the verses of Leskovac poet Borislav Zdravković: "Here fell the hero of Glory In the fight against traitors Became the glory of Vučje Dubrava And entered the ranks of the immortals. The leaf of this mountain, the stone of this water Will forever murmur about the bright act: At the first gun, at the call of Freedom, He rose and fell for the homeland."',
                    "short_description": 'The monument to Slavko Todorović was unveiled on July 4, 1973, dedicated to the first victim of the "Kukavica Partisan Detachment". It was unveiled by Svetozar Krstić. The monument was created by academic sculptor Đorđe Vasić from Leskovac.',
                    "latlng": [42.865139, 21.911223],
                    "distance_radius": 33,
                    "pictures": [f'{server_route}/static/pictures/33.jpg'],
                },
                {
                    "name": 'Hostel of the Secondary School Svetozar Krstić - Toza',
                    "description": 'The hostel you see is an extension of the Secondary School "Svetozar Krstić - Toza" from Vučje. It used to be a restaurant where students only had practice. Today, it is the first student hostel operating within a school enterprise founded by the school. The renovation of the school hostel was supported by the City of Leskovac, while the European Union provided funds for the complete equipping of the hostel through the IPA II Cross-Border Cooperation Program between Serbia and North Macedonia. In Kratovo, North Macedonia, there is also a student hostel within the brother school "Mitko Pendžukliski".',
        ...
        "sr": {
            ...
            "locations": [
                ...
                {
                    "name": 'Muzej tekstilne industrije Strojkovce',
                    "description": 'Tekstilni muzej u Strojkovcu jedini je muzej ovakve vrste u Srbiji. Smešten je u vodenici koja je podignuta u drugoj polovini XIX veka. Sudeći po veličini i prostorijama za stanovanje u njenom sastavu, bila je vlasništvo bogatih Turaka. U njoj su 1884. godine preduzimljivi Leskovčani otvorili prvu fabriku gajtana, što se smatra začetkom tekstilne industrije u Srbiji.\nZgrada predstavlja tip „crnotravske dunđerske kuće“. U levom krilu smeštena je vodenica, dok su u desnom prostorije za stanovanje u prizemlju i na spratu. Iznad ulaznog odeljenja u prizemlju je terasa sa arkadama.\nVodenica je 1959. godine otkupljena od bivših vlasnika i restaurirana. Zgrada je sačuvala specifičnu lepotu arhitekture, karakteristične za vreme u kojem je građena, a unutrašnjost je opremljena autentičnim nameštajem i predmetima iz svakodnevnog života vodeničara. U njoj su izloženi originalni predmeti koji prezentuju proces proizvodnje gajtana.\nMuzej je rekonstruisan je 2011. godine, kada je objektu vraćen stari sjaj, a nekadašnji, autentičan način proizvodnje gajtana ponovo je u funkciji. Restauriran je i kanal kojim je tekla voda čija snaga je pokretala mehanizam za okretanje čarkova i upredanje gajtana.\nTekstilni muzej u Strojkovcu je 1980. godine proglašen za kulturno dobro – spomenik kulture.',
                    "short_description": 'Tekstilni muzej u Strojkovcu jedini je muzej ovakve vrste u Srbiji.',
                    "latlng": [42.905583, 21.923250],
                    "distance_radius": 50.5,
                    "pictures": [f'{server_route}/static/pictures/29.jpg'],
                },
                {
                    "name": 'Proizvodnja "Fungo Jug"',
                    "description": 'Privredno društvo Fungo Jug osnovano je 1990.godine. Osnovna delatnost preduzeća je otkup, prerada, proizvodnja i prodaja poljoprivrednih i šumskih proizvoda. Geografski položaj i klimatski uslovi Jablaničkog okruga čine povoljan ambijent ovog kraja za razvoj različitih vrsta voća i šumskih plodova.\nFungo Jug d.o.o. je privredno društvo koje se bavi otkupom, proizvodnjom, preradom i prodajom poljoprivrednih i šumskih proizvoda. Osnovano je 1990.godine kao mešovito preduzeće sa srpsko- italijanskim kapitalom i tada je bilo 5 stalno zaposlenih radnika. Sada ima preko 50 stalno zaposlenih radnika i oko 50-100 sezonskih radnika. Prvih 10 godina, delatnost preduzeća se pretežno zasnivala na otkupu, preradi i prodaji šumskih pečuraka: vrganja, lisičarke, crne trube. Privredno društvo u svom vlasništvu i zakupu ima i dugogodišnje zasade voća u površini od oko 15 hektara u selu Lapotincu, blizu Bojnika. Tu ima zasada kupina i zasada višanja. Na većini parcela pod zasadima izgrađeni su artersijski bunari sa sistemom kap po kap, radi blagovremenog navodnjavanja. Takođe, od pre nekoliko godina od grada Leskovca uzete su u zakup na 10 godina parcele sa kruškama, jabukama i višnjama, površine oko 60 hektara.\nPreduzeće spada u kategoriju pretežnih izvoznika poljoprivrednih i šumskih proizvoda. Bavi se preradom i prodajom duboko zamrznutog voća i šumskih proizvoda za industrijsku upotrebu. Sa pojedinim kupcima postoji poslovna saradnja od 25 i više godina, sa kojima se poslovne aktivnosti dogovaraju pre početka predstojeće sezone. Preko Horeca distributera preduzeće snabdeva duboko zamrznutim proizvodima hotele i restorane u Srbiji.',
                    "short_description": 'Privredno društvo Fungo Jug osnovano je 1990. godine. Osnovna delatnost preduzeća je otkup, prerada, proizvodnja i prodaja poljoprivrednih i šumskih proizvoda.',
                    "latlng": [42.874814, 21.953399],
                    "distance_radius": 50.5,
                    "pictures": [f'{server_route}/static/pictures/30.jpg'],
                },
                {
                    ...
                    "description": 'Hram Svetog oca Nikolaja u Čukljeniku, nije poznato kada je hram podignut, ali se zna da se na ovom mestu nalazi hram iz srednjeg veka. Pominje se u turskim popisima kao manastir 1516, 1530. i 1536. godine. 1575. godine hram je porušen, ali je ubrzo obnovljen. Hram je najverovatnije ponovo stradao 1841. godine, u vreme Niške bune. Feliks Kanic je posetio ovaj manastir i našao porušeni hram. On beleži još i da se „pored temelja razorene crkvice svetog Nikole, nalazi jedva očuvana niska građevina sa poluobličastim svodom i konvencionalnim vizantijskim freskama; pored nje su još, znatno viši, solidan jednospratni konak i sporedna zgrada u kojoj nalaze smeštaj pobožni hodočasnici i izletnici, ali u one dane kad nakrivanski pop ovde služi Liturgiju ona nije dozvoljena.“ U vreme Prve seobe Srba 1690. godine, manastir je posetio pećki patrijarh Arsenije Čarnojević i u njemu boravio mesec dana. 1786. godine, u vreme mitropolita niškog Kalinika I i kaluđera Joanikija i Ignatija, podignuta je Crkva Uspenja Presvete Bogorodice. Prota Dragutin Đorđević zapisao je dve verzije o sudbini ovog hrama. Prema prvom, hram je osvetio mitropolit Kalinik, koji je zabranio da se bogosluženja obavljaju u hramu svetog Nikolaja. Prota Đorđević u ovom mitropolitovom činu vidi želju za nametanjem grčkog jezika i bogosluženja. Ovo je izazvalo veliki revolt naroda, koji je srušio ovaj hram. Prema drugom, majstor Ignjat, koji je gradio ovu Crkvu, predvideo je brzo urušenje, zbog toga što je hram napravljen od rečnog kamena belutka. Pre ovom predanju, pored Crkve je živeo izvesni pop Mihailo. Na Teodorovu subotu u snu mu se javio čovek sa belom bradom i rekao mu: „Mihailo, idi s crkvenjaka u golemo, grčku Crkvu, izvucite dveri, ikone i drugo, Crkva će se sruši.“ Nakon što su učinili ono što im je naloženo, hram se srušio. Ovu Crkvu je obnovio početkom XX veka paroh strojkovački Sava Avramović. Od starog hrama ostao je sačuvan sveti Presto, a ikone iz hrama postavljene su na ikonostasu Crkve svetog Nikolaja. Mnogo toga u ovim pričama prote Dragutina Đorđevića se ne slaže, pa se oba predanja mogu odbaciti. Primera radi, natpisi na freskama u današnjem hramu svetog Nikolaja su potpisane grčkim jezikom, a ikone na ikonostasu slovenskim. Verovatnije je da je hram Uspenja Presvete Bogorodice koji se srušio bio hram koji su podigli Srbi, a da su sačuvani svetog Nikolaja podigli grčki monasi. U hramu Uspenja Presvete Bogorodice čuva se bakrotisk na svili, Vaznesenje Hristovo sa predstavom Pećke patrijaršije, rad Hristifora Ževarovića, koji je posetio ovaj manastir 1743. godine i darivao bakrotisk. Nakon oslobođenja Južnih krajeva, manastir je 1884. godine pretvoren u parohijsku Crkvu. U porti hrama nalazi se spomenik poginulim vojnicima i civilima postradalim u Srpsko- turskom ratu. Nedaleko od hramovne porte nalazi se veoma dobro očuvana crkvena vodenica, koja je i dalje u funkciji. Najverovatnije je podignuta 1786. godine, o čemu svedoči jedan zapis kaluđera Ignatija. Vodenica je nedavno obnovljena.',
                    "short_description": 'Hram Svetog oca Nikolaja u Čukljeniku, nije poznato kada je hram podignut, ali se zna da se na ovom mestu nalazi hram iz srednjeg veka.',
                    "latlng": [42.867167, 21.960972],
                    "distance_radius": 50.5,
                    "pictures": [f'{server_route}/static/pictures/31.jpg'],
                },
                {
                    "name": 'Nakrivan',
                    "description": 'Postoji predanje da je neki meštanin ovog sela, koji je bio sakat u nogu, često odlazio kod svog spahije u Leskovac i molio ga da ga oslobodi poreza jer je bio siromašan, a uz to i sakat. Spahiji je vremenom dosadilo navaljivanje ovog seljaka, pa ga je podrugljivo nazvao Nakrivan, a po njemu je kasnije i čitavo selo dobilo naziv. Kada je reč o Nakrivanskom Čifluku, on je svoje ime dobio po ulozi koju je imao u prošlosti. Naime, on je bio čifluk, odnosno veliko prirodno dobro koje je bilo u sastavu Nakrivna i na teritoriji čifluka su meštani Nakrivna imali svoje vikendice i obradive površine, gde su povremeno odlazili kako bi obavljali različite poslove. Selo je smešteno na pola puta između Strojkovca i Čukljenika, na obalama Nakrivanske reke i pored puta koji je ovuda vodio punih 400 godina za vreme Turaka, vezujući preko planine Kukavice, Leskovac i Vranje, odnosno Beograd sa Solunom. Naseljeno gotovo pod samom Kitom, završnim visom Kukavice, u središnjem delu kotline, na talasastoj terasi koju je izmodelirala Nakrivanska reka, Nakrivan je podplaninsko selo i u njegovom ataru nalaze se ravnice, brda i planine. Takav topografski položaj sela pogodovao je njegovom razvoju, pa je Nakrivan oduvek bio po veličini drugo selo u celom Porečju, koje je imalo i svoj čifluk — današnji Nakrivanski Čifluk i svoj zaseok — istočni deo Rašinog Laza.',
                    "short_description": 'Postoji predanje da je neki meštanin ovog sela, koji je bio sakat u nogu, često odlazio kod svog spahije u Leskovac i molio ga da ga oslobodi poreza jer je bio siromašan, a uz to i sakat. Spahiji je vremenom dosadilo navaljivanje ovog seljaka, pa ga je podrugljivo nazvao Nakrivan, a po njemu je kasnije i čitavo selo dobilo naziv.',
                    "latlng": [42.884230, 21.942366],
                    "distance_radius": 50.5,
                    "pictures": [f'{server_route}/static/pictures/32.jpg'],
                },
                {
                    "name": 'Spomenik palom borcu',
                    "description": 'Spomenik Slavku Todoroviću otkriven je 4. jula 1973. godine, posvećen prvoj žrtvi „Kukavičkog partizanskog odreda“. Otkrio ga je Svetozar Krstić. Autor spomenika je akademski vajar Đorđe Vasić iz Leskovca. Na spomeniku su urezani stihovi leskovačkog pesnika Borislava Zdravkovića: „Ovde je pao junak Slave U borbi protiv izdajnika Postao slava vučje Dubrave I ušao u red besmrtnika. List ove gore, kamen ove vode Šumiće večno o svetlom činu: Na prvu pušku, na zov Slobode, Ustade i pade za domovinu.“',
                    "short_description": 'Spomenik Slavku Todoroviću otkriven je 4. jula 1973. godine, posvećen prvoj žrtvi „Kukavičkog partizanskog odreda“. Otkrio ga je Svetozar Krstić. Autor spomenika je akademski vajar Đorđe Vasić iz Leskovca.',
                    "latlng": [42.865139, 21.911223],
                    "distance_radius": 50.5,
                    "pictures": [f'{server_route}/static/pictures/33.jpg'],
                },
